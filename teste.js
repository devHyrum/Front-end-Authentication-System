...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 dark:bg-customDark dark:text-white min-h-screen transition-colors duration-500 px-4">
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-[#292326] shadow-md rounded-2xl px-6 pt-6 pb-8 border-[#BDBDBD] dark:border-[#BDBDBD] border-solid border-[1px] w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-[473.83px] transition-colors duration-100">
        <img src={isDarkMode ? devchallengesLight : devchallenges} alt="devchallenges" className='pt-5 mx-auto'/>
        <p className='font-semibold py-6 text-lg text-center'>Login</p>
        ...
        <div className='flex flex-col items-center'>
          <p className='text-[#828282] dark:text-[#BDBDBD] p-5 pt-7 transition-colors duration-500 text-center'>or continue with these social profile</p>
          <ul className='flex gap-4 justify-center'>
            ...
            <li className='border-solid border-[#828282] dark:border-[#BDBDBD] border-2 p-3 rounded-full cursor-pointer hover:shadow-md hover:shadow-indigo-500/40 transition-colors duration-500'><img src={facebook} alt="facebook"    className='w-[18px]'/></li>
            <li className='border-solid border-[#828282] dark:border-[#BDBDBD] border-2 p-3 rounded-full cursor-pointer hover:shadow-md hover:shadow-indigo-500/40 transition-colors duration-500'><img src={twitter} alt="twitter"     className='w-[18px]'/></li>
            <li className='border-solid border-[#828282] dark:border-[#BDBDBD] border-2 p-3 rounded-full cursor-pointer hover:shadow-md hover:shadow-indigo-500/40 transition-colors duration-500'><img src={github} alt="github"    className='w-[18px]'/></li>
          </ul>
